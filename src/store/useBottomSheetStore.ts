...
interface BottomSheetStore {
  ...
  setBottomSheetAbsoluteBottom: (bottomSheetAbsoluteBottom: React.ReactNode) => void;
}

export const useBottomSheetStore = create<BottomSheetStore>()(devtools((set, get) => ({
  ...
  setBottomSheetAbsoluteBottom: (bottomSheetAbsoluteBottom: React.ReactNode) => {
